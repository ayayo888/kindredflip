      ...
      */}
      <div className="fixed z-50 flex flex-col gap-3 
        ...
        >
          ...
          {/* Icon Button (WhatsApp Green) */}
          <div className="w-10 h-10 md:w-12 md:h-12 bg-[#25D366] border-2 border-black rounded-xl flex items-center justify-center shadow-hard md:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-none transition-all active:translate-y-0 md:mr-4">
            {/* WhatsApp SVG */}
